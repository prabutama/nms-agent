...
- `nms-agentctl view` uses `paths.view_socket` when configured; otherwise it defaults to `/run/nms-agent/view.sock` for Linux/systemd-style runtime environments.
