...
| `internal/integrations/thingsboard/client.go` | REST client ThingsBoard dengan dual API key: customer-scope (device lookup, relation, topology) dan tenant-scope (alarm create/clear) via X-Authorization header. |
