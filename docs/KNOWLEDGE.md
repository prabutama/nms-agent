...
| `internal/integrations/thingsboard/client.go` | REST client ThingsBoard berbasis API key untuk check auth, lookup relation/device (via customer-scoped endpoint), dan publish SERVER_SCOPE attributes asset site. |
