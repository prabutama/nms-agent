...
| `internal/integrations/thingsboard/client.go` | REST client ThingsBoard berbasis API key untuk check auth, lookup relation/device, create/clear alarm, dan publish SERVER_SCOPE attributes asset site. |
